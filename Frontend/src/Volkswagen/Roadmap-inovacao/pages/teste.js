                ...
                <div class="menu-inner">
                    <nav>
                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                <a href="javascript:void(0)" aria-expanded="true"><Home/><span>Inovações</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><Task/><span>Inovações Aceitas</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><Block/><span>Inovações Recusadas</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><Dashboard/><span>Dashboard</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
